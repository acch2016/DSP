/**
	\file GPIO.h
	\brief Es es el archivo header del driver para el GPIO de la Kinetis k64
				 Este contiene todas las funciones de configuración  y de tiempo rel
				 Este es la API para el periferico del GPIO
	\author J. Luis Pizano Escalante, luispizano@iteso.mx
	\Fecha	7/09/2014
	\todo
	   Las interrupciones no están incluidas en esta API
 */
...
/********************************************************************************************/
/*!
 	 \brief  Retorna el valor de la bandera de la interrupción del puerto B
 	 \return uint8
 */
uint8 FlagPortB_Read();

/********************************************************************************************/
/********************************************************************************************/
/********************************************************************************************/
/*!
 	 \brief  Limpia el valor de la bandera de la interrupción del puerto B
 	 \return void
 */
void FlagPortB_Clear();

/********************************************************************************************/
/********************************************************************************************/
/********************************************************************************************/
/*!
 	 \brief  Retorna el valor de la bandera de la interrupción del puerto C
 	 \return uint8
 */
...
/********************************************************************************************/
/*!
 	 \brief  Limpia el valor de la bandera de la interrupción del puerto C
 	 \return void
 */
...
/********************************************************************************************/
/*!
 	 \brief  Retorna el valor de la bandera de la interrupción del puerto A
 	 \return uint8
 */
uint8 readFlag_PORTA();

/********************************************************************************************/
/********************************************************************************************/
/********************************************************************************************/
/*!
 	 \brief  Limpia el valor de la bandera de la interrupción del puerto A
 	 \return void
 */
void clearFlag_PORTA();
