/**
	\file
	Descripción: Este es el archivo fuente para el driver del GPIO para la Kinetis K64
...
void PORTA_IRQHandler() /**Vector de interrupción para el puerto A*/
{
...
void PORTB_IRQHandler()	/** Vector para la interrupción del puerto B*/
{
	funwithFlags.Flagfield.FlagPortB = TRUE;
	GPIO_clearInterrupt(GPIOB);
}

//API para banderas del generador de señales

uint8 readFlag_PORTA() /**Función que regresa el estado del puerto A*/
{
	return 	funwithFlags.Flagfield.FlagPortA;
}

void clearFlag_PORTA() /**Función que limpia la bandera del puerto A*/
{
...
uint8 FlagPortB_Read() /**Función que regresa el estado del puerto B*/
{
	return funwithFlags.Flagfield.FlagPortB;
}

void FlagPortB_Clear()	/**Función que limpia la bandera del puerto B*/
{
	funwithFlags.Flagfield.FlagPortB = FALSE;
}

//API para banderas de motor
uint8 readFlag_PORTC() /**Función que regresa el estado del puerto C*/
{
	return 	funwithFlags.Flagfield.FlagPortC;
}

void clearFlag_PORTC()	/**Función que limpia la bandera del puerto C*/
{
