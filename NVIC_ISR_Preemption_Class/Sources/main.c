/**
	\file
	\brief
		This project shows the pre-emtion of interrupts. Also it shows how
		the MCU can be trapped in an interrupts if the interrupt flag in the peripheral is not
		cleared.
		Note: Not all peripheral needs to clear its interrupt flga, i.e., the uart.
...
int main(void)
{
	...
	/**Enables and sets a particular interrupt and its priority*/
	NVIC_enableInterruptAndPriotity(PORTA_IRQ,PRIORITY_10);
