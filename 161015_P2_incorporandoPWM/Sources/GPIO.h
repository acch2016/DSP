...
/**Union que contiene todas las banderas de las interrupciones de los botones*/
typedef union  Flags{
	uint8 AllFlags;
	struct{
		uint8 FlagButton_1 :1;
		uint8 FlagButton_2 :1;
		uint8 FlagButton_3 :1;
		uint8 FlagButton_4 :1;
		uint8 FlagButton_5 :1;
		uint8 FlagButton_6 :1;
	}Flagfield;
}Flags;
...
/*!
 	 ...
 	 \return uint8
 */
uint8 readFlag_Button(ButtonType);
...
/*!
 	 ...
 	 \return void
 */
void clearFlag_Button(ButtonType);
