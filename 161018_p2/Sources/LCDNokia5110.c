...
void LCDNokia_writeByte(uint8 DataOrCmd, uint8 data)//ss
{
	if(DataOrCmd)
	...
	SPI_startTranference(SPI_0);/**Inicia la transferencia. Pasas el canal*/
	SPI_sendOneByte(data);/** Envia lo que se desea transmitir */
	SPI_stopTranference(SPI_0);/**Termina la transferencia*/
}
